...
val keystorePropertiesFile =
    sequenceOf(
        ...
        rootProject.file("../../PuttingCaddy/android/key.properties"),
        rootProject.file("../../android/key.properties")
    ).firstOrNull { it.exists() }
        ?: error("key.properties not found (copy to this android/ or keep sibling PuttingCaddy/android/key.properties)")
