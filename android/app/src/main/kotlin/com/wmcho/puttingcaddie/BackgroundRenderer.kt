...
class BackgroundRenderer {
    ...
    fun createOnGlThread(context: Context) {
        ...
        contrastLocation = GLES20.glGetUniformLocation(backgroundShader, "uContrast")
        gammaLocation = GLES20.glGetUniformLocation(backgroundShader, "uGamma")
        saturationLocation = GLES20.glGetUniformLocation(backgroundShader, "uSaturation")
    ...
    fun draw(frame: Frame) {
        ...
        val tuning = OutdoorPreviewTuning.active()
        if (brightnessLocation >= 0) GLES20.glUniform1f(brightnessLocation, tuning.brightness)
        if (contrastLocation >= 0) GLES20.glUniform1f(contrastLocation, tuning.contrast)
        if (gammaLocation >= 0) GLES20.glUniform1f(gammaLocation, tuning.gamma)
        if (saturationLocation >= 0) GLES20.glUniform1f(saturationLocation, tuning.saturation)
